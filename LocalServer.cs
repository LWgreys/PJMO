//
// ASCOM.PJMO.Telescope Local COM Server
//
...
namespace ASCOM.LocalServer
{
    public static class Server
    {
        ...
        private static string localServerAppId = "{2aef43db-559e-498c-9c6e-e5ab4e788f65}"; // Our AppId
        ...
        static void Main(string[] args)
        {
            ...
            TL = new TraceLogger("", "PJMO.LocalServer")
            {
            ...
            Thread.CurrentThread.Name = "PJMO Local Server Thread";
        ...
        private static void RegisterObjects()
        {
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show("Error while registering the server:\n" + ex.ToString(), "ASCOM.PJMO.Telescope", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                return;
            }
        ...
        private static void ElevateSelf(string argument)
        {
            ...
            {
                TL.LogMessage("IsAdministrator", $"The ASCOM.PJMO.Telescope was not " + (argument == "/register" ? "registered" : "unregistered because you did not allow it."));
                MessageBox.Show("The ASCOM.PJMO.Telescope was not " + (argument == "/register" ? "registered" : "unregistered because you did not allow it.", "ASCOM.PJMO.Telescope", MessageBoxButtons.OK, MessageBoxIcon.Warning));
            }
            catch (Exception ex)
            {
                TL.LogMessageCrLf("IsAdministrator", $"Exception: {ex}");
                MessageBox.Show(ex.ToString(), "ASCOM.PJMO.Telescope", MessageBoxButtons.OK, MessageBoxIcon.Stop);
            }
            return;
        }
        ...
        private static bool RegisterClassFactories()
        {
            ...
            foreach (Type driverType in driverTypes)
            {
                ...
                if (!factory.RegisterClassObject())
                {
                    ...
                    MessageBox.Show("Failed to register class factory for " + driverType.Name, "ASCOM.PJMO.Telescope", MessageBoxButtons.OK, MessageBoxIcon.Stop);
                    return false;
                }
            ...
            if (args.Length > 0)
            {
                switch (args[0].ToLower())
                {
                    ...
                    default:
                        ...
                        MessageBox.Show("Unknown argument: " + args[0] + "\nValid are : -register, -unregister and -embedding", "ASCOM.PJMO.Telescope", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        break;
                }
            }
            else
