...
//
// ASCOM Telescope driver for PJMO
//
...
namespace ASCOM.PJMO.Telescope
{
    //
    ...
    //
    // Your driver's DeviceID is ASCOM.PJMO.Telescope
    //
    // The COM Guid attribute sets the CLSID for ASCOM.PJMO.Telescope
    // The COM ClassInterface/None attribute prevents an empty interface called _PJMO from being created and used as the [default] interface
    //
    ...
    /// </summary>
    [ComVisible(true)]
    [Guid("daa17a50-cf6b-4767-b6b9-cd51bb5866b9")]
    [ProgId("ASCOM.PJMO.Telescope")]
    [ServedClassName("ASCOM Telescope Driver for PJMO")] // Driver description that appears in the Chooser, customise as required
    ...
    public class Telescope : ReferenceCountedObjectBase, ITelescopeV4, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PJMO"/> class. Must be public to successfully register for COM.
        /// </summary>
        public Telescope()
        {
            try
            {
                ...
                tl = new TraceLogger("", "PJMO.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show($"{ex.Message}", "Exception creating ASCOM.PJMO.Telescope", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
